      ...
      <i-col span="12">
        ...
        <Card class="virtualMachine-left">
          <div slot="title" class="virtualMachine-left-header">
            ...
            <span>|</span>
            <p @click="click4" :class="{active:isActive4}">发电目标值</p>
            <span>|</span>
            <p @click="click2" :class="{active:isActive2}">发电量完成率</p>
            <!-- 事件类型 -->
          ...
          if (res.status === 200) {
            ...
            if (data === null) {
              data = {
                ...
                joinUnit: '', // 参与虚拟机组数
                saveCo2: '', // 减排CO2
                peakShavingValleyFillings: [],
                unitControlTypeOrderResps: []
              }
            }
            _this.basicInfoList = data
            _this.peakPeelData = data.peakShavingValleyFillings
            _this.planeTypeData = data.unitControlTypeOrderResps
            _this.electricityCompletionRateData =
              data.unitControlTypeOrderResps
            _this.plannedValueDistributionIntervalData =
              data.unitControlTypeOrderResps
          }
        })
    }
