  ...
  <div class="plantPlanEnquiry">
    <div class="plantPlanEnquiry-list">
      ...
      <Row class="plantPlanEnquiry-listOne">
        ...
        <i-col span="6">
          <div class="plantPlanEnquiry-list-btn" @click="topPanelQuery">
            查询
          </div>
        </i-col>
      </Row>
  ...
  methods: {
    ...
    changeDate1(date) {
      ...
      if (this.radioValue === "day") {
        this.form.date1 =
          this.form.date1.length === 10
            ? this.form.date1
            : this.form.date1 + "-01";
      } else if (this.radioValue === "month") {
        this.form.date1 =
          this.form.date1.length === 7
            ? this.form.date1
            : this.form.date1.substring(0, 7);
      }
    },
    onSelectedLoadData() {
    ...
    goToSinglePlantPlanDetail(data) {
      ...
      this.$router.push({
        ...
        params: { planNo: data.row.planNo, planName: data.row.planName }
      });
    }
  }
};
