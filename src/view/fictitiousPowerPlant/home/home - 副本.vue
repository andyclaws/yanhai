  ...
  <div class="vituralHome" :style="mainHeight">
    <Row style="height: 100%" :gutter="6">
      <i-col span="7" style="height:100%">
        <Row class="baseInfoRow">
          <Card class="baseInfo">
            <div class="infoTitle">||| 基本信息</div>
            <Row :gutter="6">
              <i-col span="6" class="itemCol">
                <div class="baseInfoImgDiv divide">
                  <img src="./images/u1289.png" />
                </div>
                <div class="baseInfoItem">因子数</div>
                <div class="baseInfoValue">{{baseInfoData.divideCount}}</div>
              </i-col>
              <i-col span="6" class="itemCol">
                <div class="baseInfoImgDiv user">
                  <img src="./images/u1282.png" />
                </div>
                <div class="baseInfoItem">业主数</div>
                <div class="baseInfoValue">{{baseInfoData.userCount}}</div>
              </i-col>
              <i-col span="6" class="itemCol">
                <div class="baseInfoImgDiv medicalGroup">
                  <img src="./images/u1296.png" />
                </div>
                <div class="baseInfoItem">机组数</div>
                <div class="baseInfoValue">{{baseInfoData.medicalGroupCount}}</div>
              </i-col>
              <i-col span="6" class="itemCol">
                <div class="baseInfoImgDiv onlineRate">
                  <img src="./images/online.png" />
                </div>
                <div class="baseInfoItem">在线率</div>
                <div class="baseInfoValue">{{baseInfoData.onlineRate}}%</div>
              </i-col>
            </Row>
          </Card>
        </Row>
        <Row class="medicalTypeRow">
          <Card class="medicalType">
            <div class="typeTitle">||| 机组类型</div>
            <div class="typeMain">
              <MedicalTypePie :pieData="medicalPieData" style="height: 102%;" />
            </div>
          </Card>
        </Row>
        <Row class="medicalSpreadRow">
          <Card class="medicalSpread">
            <div class="spreadTitle">||| 机组分布</div>
        ...
        <Row class="deviceResolveRow">
          <Card class="deviceResolve">
            <div class="resovleTitle">||| 设备因子分解</div>
            <div class="resolveMain">
              <DeviceResolve :deviceData="deviceData" style="height: 90%;" />
            </div>
          </Card>
        </Row>
      </i-col>
      <i-col span="9" style="height: 100%;">
        <Row class="spreadMapRow">
          ...
          <Card class="spreadMap" v-if="mapModel === 1">
            ...
            <SpreadDetailMap :mapData="detailMapData" :mapName="mapName" style="height: 102%;" />
        ...
        <Row class="monthSupportRow">
          <Card class="monthSupport">
            <div class="supportTitle">||| 当月发电计划</div>
            <div class="supportMain">
              <MonthSupport :monthData="monthData" style="height: 102%;" />
            </div>
          </Card>
        </Row>
      </i-col>
      <i-col span="8" style="height:100%">
        <Row class="dataStatisRow">
          <Card class="dataStatis">
            <div class="statisTitle">||| 数据统计</div>
            <Row class="statisInnerRow" :gutter="6">
              <i-col span="9">
                <div class="statisInfo">
                  <span>总发电量:</span>
                  <span class="statisValue">{{statis.totalElec}}kWh</span>
                </div>
              </i-col>
              <i-col span="8">
                <div class="statisInfo">
                  <span>交易总金额:</span>
                  <span class="statisValue">{{statis.totalPrice}}万元</span>
                </div>
              </i-col>
              <i-col span="7">
                <div class="statisInfo">
                  <span>节约标煤:</span>
                  <span class="statisValue">{{statis.ecoCo}}t</span>
                </div>
              </i-col>
            </Row>
            <Row class="statisInnerRow" :gutter="6">
              <i-col span="9">
                <div class="statisInfo">
                  <span>总削峰量:</span>
                  <span class="statisValue">{{statis.cutPeakCount}}kWh</span>
                </div>
              </i-col>
              <i-col span="8">
                <div class="statisInfo">
                  <span>交易总次数:</span>
                  <span class="statisValue">{{statis.tradeTotalCount}}次</span>
                </div>
              </i-col>
              <i-col span="7">
                <div class="statisInfo">
                  <span>减排CO2:</span>
                  <span class="statisValue">{{statis.cutCo}}t</span>
                </div>
              </i-col>
            </Row>
            <Row :gutter="6">
              <i-col span="24">
                <div class="statisInfo">
                  <span>总填谷量:</span>
                  <span class="statisValue">{{statis.fullValCount}}kWh</span>
                </div>
              </i-col>
            </Row>
          </Card>
        ...
        <Row class="realTimeCurveRow">
          <Card class="realTimeCurve">
            <div class="realTimeTitle">||| 今日负荷曲线</div>
        ...
        <Row class="topFineRow">
          <Card class="topFine">
            <div class="topFineTitle">||| 虚拟电厂发电前五</div>
            <div class="chooseBar">
              <div
                :class="[isBarChoose === '0' ? 'isChoose' : '', 'chooseBtn']"
                @click="chooseBarModel('0')"
              >响应次数</div>
              <div
                :class="[isBarChoose === '1' ? 'isChoose' : '', 'chooseBtn']"
                @click="chooseBarModel('1')"
              >发电量</div>
            </div>
            <div class="resolveMain">
              <TopFine :totalData="topFineData" :selectType="isBarChoose" style="height: 100%;" />
            </div>
          </Card>
        </Row>
      </i-col>
...
export default {
      ...
      api
        ...
        .then(res => {
          ...
          if (typeof obj !== 'undefined' && obj !== null) {
            _this.baseInfoData.divideCount = _this.removeNull(obj.subdeviceCnt, '0')
            _this.baseInfoData.userCount = _this.removeNull(obj.ownerCnt, '0')
            _this.baseInfoData.medicalGroupCount = _this.removeNull(obj.unitCnt, '0')
      ...
      api
        ...
        .then(res => {
          ...
          if (typeof list !== 'undefined' && list !== null && list.length > 0) {
            _this.spreadRoseData = list
            let total = 0
            for (let index = 0; index < list.length; index++) {
              total += Number(list[index].value)
            }
            _this.totalMedicals = '' + Number(total)
          }
        })
        .catch(err => {
          _this.$Message.error('基本信息查询失败！')
      ...
      api
        ...
        .then(res => {
          ...
          if (typeof data !== 'undefined' && data !== null) {
            ...
            _this.statis.tradeTotalCount = _this.removeNull(data.finishPlanCnt, '0')
    ...
    getTodayLoadCurve: function () {
      ...
      api
        ...
        .then(res => {
          let data = res.data.data
          if (typeof data !== 'undefined' && data !== null) {
            _this.realCurve.upList = data.upList
            _this.realCurve.downList = data.downList
            _this.realCurve.aplantPForecasts = data.aplantPForecasts
            _this.realCurve.aplantPRealtimes = data.aplantPRealtimes
          } else {
  ...
  created () {
    var _this = this
    this.$nextTick(() => {
      _this.getUnitSumAndOnline()
      _this.getUnitDistribute()
      _this.getUnitTypeNums()
      _this.getSubDeviceShow()
      _this.getAramNum()
      _this.getMonthPower()
      _this.getUnitPowerTop(1)
      _this.getRealLoad()
      _this.getTodayLoadCurve()
      _this.timer1 = setInterval(_this.getRealLoad, 900000)
      _this.timer2 = setInterval(_this.getTodayLoadCurve, 900000)
    })
  },
  beforeDestroy () {
    let _this = this
