...
<template>
  <div class="windowWithChildWindow">
    ...
    <Tables border ref="tables"  :filename="'台区发电量信息'" :height="tableHeight - 50" :columns="columns" :axiosUrl="axiosUrl" :axiosData="axiosData" class="table"/>
    <Modals v-model="show_sonTables" draggable :zIndex="11000" :width="boxWidth < 1100 ? '950px' : boxWidth * 0.85 + 'px'"
            @on-cancel="show_sonTables = false" title="台区电量下钻明细" footer-hide>
