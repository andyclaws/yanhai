export default {
  ...
  closeAll: 'closeAll',
  columnScreen: 'Column screening',
  search: 'search',
  searchByKeyWords: 'Enter keyword search',
  export: {
    export: 'export',
    exportCurrentExcel: 'exportCurrentExcel',
    exportCurrentCvs: 'exportCurrentCvs',
    exportTotalExcel: 'exportTotalExcel',
    exportCurrentPic: 'exportCurrentPic',
