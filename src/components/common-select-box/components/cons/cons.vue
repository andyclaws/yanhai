<template>
  <div>
    <Form ref="formValidate" :model="form" :rules="ruleValidate" :label-width="80">
      <Row>
        <Col span="12">
          <FormItem :label="$t('consNo')" prop="consNo">
            <Input v-model="form.consNo" :placeholder="$t('please_input_consNo')" clearable></Input>
          </FormItem>
        </Col>
        <Col span="12">
          <FormItem :label="$t('consType')" prop="consType">
            <Select v-model="form.consType" :placeholder="$t('please_input_consType')" clearable>
      ...
      <Row>
        <Col span="12">
          <FormItem :label="$t('meterAssetNo')" prop="meterAssetNo">
            <Input v-model="form.meterAssetNo" :placeholder="$t('please_input_meterAssetNo')" clearable></Input>
          </FormItem>
        </Col>
        <Col span="12">
          <FormItem :label="$t('meterReadNumber')" prop="meterReadNumber">
            <Input v-model="form.meterReadNumber" :placeholder="$t('please_input_meterReadNumber')" clearable></Input>
          </FormItem>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col span="12">
          <FormItem :label="$t('protocolCode')" prop="protocolCode">
            <Select v-model="form.protocolCode" :placeholder="$t('please_input_protocolCode')" clearable>
              <Option v-for="item in protocolCodes" :value="item.code" :key="item.code">{{ item.name }}</Option>
            </Select>
          </FormItem>
        </Col>
      </Row>
