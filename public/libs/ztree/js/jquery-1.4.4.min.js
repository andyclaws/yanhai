...
(function (E, B) {
  function ka (a, b, d) { if (d === B && a.nodeType === 1) { d = a.getAttribute('data-' + b); if (typeof d === 'string') { try { d = d === 'true' ? true : d === 'false' ? false : d === 'null' ? null : !c.isNaN(d) ? parseFloat(d) : Ja.test(d) ? c.parseJSON(d) : d } catch (e) {}c.data(a, b, d) } else d = B } return d } function U () { return false } function ca () { return true } function la (a, b, d) { d[0].type = a; return c.event.handle.apply(b, d) } function Ka (a) {
    var b, d, e, f, h, l, k, o, x, r, A, C = []; f = []; h = c.data(this, this.nodeType ? 'events' : '__events__'); if (typeof h === 'function') {
      h =
h.events
...
a + '>').appendTo('body'), d = b.css('display'); b.remove(); if (d === 'none' || d === '')d = 'block'; ea[a] = d
    ...
    function a () { if (!b.isReady) { try { t.documentElement.doScroll('left') } catch (j) { setTimeout(a, 1); return }b.ready() } } var b = function (j, s) { return new b.fn.init(j, s) }, d = E.jQuery, e = E.$, f, h = /^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]+)$)/, l = /\S/, k = /^\s+/, o = /\s+$/, x = /\W/, r = /\d/, A = /^<(\w+)\s*\/?>(?:<\/\1>)?$/,
      ...
      s) {
      var v, z, H; if (!j) return this; if (j.nodeType) { this.context = this[0] = j; this.length = 1; return this } if (j === 'body' && !s && t.body) { this.context = t; this[0] = t.body; this.selector = 'body'; this.length = 1; return this } if (typeof j === 'string') {
        if ((v = h.exec(j)) && (v[1] || !s)) {
          if (v[1]) {
        ...
        } else if (!s && !x.test(j)) { this.selector = j; this.context = t; j = t.getElementsByTagName(j); return b.merge(this, j) } else return !s || s.jquery ? (s || f).find(j) : b(s).find(j)
    ...
    pushStack: function (j, s, v) { var z = b(); b.isArray(j) ? M.apply(z, j) : b.merge(z, j); z.prevObject = this; z.context = this.context; if (s === 'find')z.selector = this.selector + (this.selector ? ' ' : '') + v; else if (s)z.selector = this.selector + '.' + s + '(' + v + ')'; return z },
...
-1 ? this.slice(j) : this.slice(j, +j + 1)
    ...
    push: M,
    sort: [].sort,
    splice: [].splice }; b.fn.init.prototype = b.fn; b.extend = b.fn.extend = function () {
    ...
    }; b.extend({ noConflict: function (j) { E.$ = e; if (j)E.jQuery = d; return b },
      isReady: false,
      readyWait: 1,
      ready: function (j) {
        j === true && b.readyWait--
...
!F.call(j, 'constructor') && !F.call(j.constructor.prototype, 'isPrototypeOf')) return false; for (var s in j);return s === B || F.call(j, s)
      ...
      parseJSON: function (j) { if (typeof j !== 'string' || !j) return null; j = b.trim(j); if (C.test(j.replace(J, '@').replace(w, ']').replace(I, ''))) return E.JSON && E.JSON.parse ? E.JSON.parse(j) : (new Function('return ' + j))(); else b.error('Invalid JSON: ' + j) },
      noop: function () {},
...
l.test(j)) { var s = t.getElementsByTagName('head')[0] || t.documentElement, v = t.createElement('script'); v.type = 'text/javascript'; if (b.support.scriptEval)v.appendChild(t.createTextNode(j)); else v.text = j; s.insertBefore(v, s.firstChild); s.removeChild(v) }
      ...
      each: function (j, s, v) {
        var z, H = 0, G = j.length, K = G === B || b.isFunction(j); if (v) if (K) for (z in j) { if (s.apply(j[z], v) === false) break } else for (;H < G;) { if (s.apply(j[H++], v) === false) break } else if (K) {
          for (z in j) {
            if (s.call(j[z],
              z, j[z]) === false) break
          }
      ...
      makeArray: function (j, s) { var v = s || []; if (j != null) { var z = b.type(j); j.length == null || z === 'string' || z === 'function' || z === 'regexp' || b.isWindow(j) ? M.call(v, j) : b.merge(v, j) } return v },
      inArray: function (j, s) { if (s.indexOf) return s.indexOf(j); for (var v = 0, z = s.length; v < z; v++) if (s[v] === j) return v; return -1 },
      merge: function (j,
        s) { var v = j.length, z = 0; if (typeof s.length === 'number') for (var H = s.length; z < H; z++)j[v++] = s[z]; else for (;s[z] !== B;)j[v++] = s[z++]; j.length = v; return j },
      grep: function (j, s, v) { var z = [], H; v = !!v; for (var G = 0, K = j.length; G < K; G++) { H = !!s(j[G], G); v !== H && z.push(j[G]) } return z },
...
[]; return { browser: j[1] || '', version: j[2] || '0' }
    ...
    c.support = {}; var a = t.documentElement, b = t.createElement('script'), d = t.createElement('div'), e = 'script' + c.now(); d.style.display = 'none'; d.innerHTML = "   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>"; var f = d.getElementsByTagName('*'), h = d.getElementsByTagName('a')[0], l = t.createElement('select'),
      ...
      c.support = { leadingWhitespace: d.firstChild.nodeType === 3,
        ...
        reliableHiddenOffsets: true }; l.disabled = true; c.support.optDisabled = !k.disabled; b.type = 'text/javascript'; try { b.appendChild(t.createTextNode('window.' + e + '=1;')) } catch (o) {}a.insertBefore(b, a.firstChild); if (E[e]) { c.support.scriptEval = true; delete E[e] } try { delete b.test } catch (x) { c.support.deleteExpando = false }a.removeChild(b); if (d.attachEvent && d.fireEvent) {
...
c.cache; if (!(e && !f && typeof b === 'string' && d === B)) { if (e)f || (a[c.expando] = f = ++c.uuid); else h = a; if (typeof b === 'object') if (e)h[f] = c.extend(h[f], b); else c.extend(h, b); else if (e && !h[f])h[f] = {}; a = e ? h[f] : h; if (d !== B)a[b] = d; return typeof b === 'string' ? a[b] : a }
    ...
    acceptData: function (a) { if (a.nodeName) { var b = c.noData[a.nodeName.toLowerCase()]; if (b) return !(b === true || a.getAttribute('classid') !== b) } return true } }); c.fn.extend({ data: function (a, b) {
    var d = null; if (typeof a === 'undefined') { if (this.length) { var e = this[0].attributes, f; d = c.data(this[0]); for (var h = 0, l = e.length; h < l; h++) { f = e[h].name; if (f.indexOf('data-') === 0) { f = f.substr(5); ka(this[0], f, d[f]) } } } return d } else if (typeof a === 'object') {
  ...
  removeData: function (a) { return this.each(function () { c.removeData(this, a) }) } }); c.extend({ queue: function (a, b, d) {
    if (a) {
      b = (b || 'fx') + 'queue'; var e =
c.data(a, b); if (!d) return e || []; if (!e || c.isArray(d))e = c.data(a, b, c.makeArray(d)); else e.push(d); return e
  ...
  dequeue: function (a, b) { b = b || 'fx'; var d = c.queue(a, b), e = d.shift(); if (e === 'inprogress')e = d.shift(); if (e) { b === 'fx' && d.unshift('inprogress'); e.call(a, function () { c.dequeue(a, b) }) } } }); c.fn.extend({ queue: function (a, b) { if (typeof a !== 'string') { b = a; a = 'fx' } if (b === B) return c.queue(this[0], a); return this.each(function () { var d = c.queue(this, a, b); a === 'fx' && d[0] !== 'inprogress' && c.dequeue(this, a) }) },
    ...
    delay: function (a, b) { a = c.fx ? c.fx.speeds[a] || a : a; b = b || 'fx'; return this.queue(b, function () { var d = this; setTimeout(function () { c.dequeue(d, b) }, a) }) },
    clearQueue: function (a) { return this.queue(a || 'fx', []) } }); var sa = /[\n\t]/g, ha = /\s+/, Sa = /\r/g, Ta = /^(?:href|src|style)$/, Ua = /^(?:button|input)$/i, Va = /^(?:button|input|object|select|textarea)$/i, Wa = /^a(?:rea)?$/i, ta = /^(?:radio|checkbox)$/i; c.props = { 'for': 'htmlFor',
    'class': 'className',
    readonly: 'readOnly',
    maxlength: 'maxLength',
    ...
    tabindex: 'tabIndex',
    usemap: 'useMap',
    frameborder: 'frameBorder' }; c.fn.extend({ attr: function (a, b) { return c.access(this, a, b, true, c.attr) },
    removeAttr: function (a) { return this.each(function () { c.attr(this, a, ''); this.nodeType === 1 && this.removeAttribute(a) }) },
    addClass: function (a) {
      if (c.isFunction(a)) return this.each(function (x) { var r = c(this); r.addClass(a.call(this, x, r.attr('class'))) }); if (a && typeof a === 'string') {
...
1) if (f.className) { for (var h = ' ' + f.className + ' ', l = f.className, k = 0, o = b.length; k < o; k++) if (h.indexOf(' ' + b[k] + ' ') < 0)l += ' ' + b[k]; f.className = c.trim(l) } else f.className = a
    ...
    removeClass: function (a) {
      if (c.isFunction(a)) return this.each(function (o) { var x = c(this); x.removeClass(a.call(this, o, x.attr('class'))) }); if (a && typeof a === 'string' || a === B) {
        for (var b = (a || '').split(ha), d = 0, e = this.length; d < e; d++) {
          var f = this[d]; if (f.nodeType === 1 && f.className) {
            if (a) {
    ...
    hasClass: function (a) { a = ' ' + a + ' '; for (var b = 0, d = this.length; b < d; b++) if ((' ' + this[b].className + ' ').replace(sa, ' ').indexOf(a) > -1) return true; return false },
    val: function (a) {
      if (!arguments.length) {
        var b = this[0]; if (b) {
  ...
  c.event = { add: function (a, b, d, e) {
    if (!(a.nodeType === 3 || a.nodeType === 8)) {
      if (c.isWindow(a) && a !== E && !a.frameElement)a = E; if (d === false)d = U; else if (!d) return; var f, h; if (d.handler) { f = d; d = f.handler } if (!d.guid)d.guid = c.guid++; if (h = c.data(a)) {
        var l = a.nodeType ? 'events' : '__events__', k = h[l], o = h.handle; if (typeof k === 'function') { o = k.handle; k = k.events } else if (!k) { a.nodeType || (h[l] = h = function () {}); h.events = k = {} } if (!o) {
          h.handle = o = function () {
...
d && d.scrollTop || 0) - (b && b.clientTop || d && d.clientTop || 0)
  ...
  guid: 1E8,
  proxy: c.proxy,
  special: { ready: { setup: c.bindReady, teardown: c.noop },
    live: { add: function (a) { c.event.add(this, Y(a.origType, a.selector), c.extend({}, a, { handler: Ka, guid: a.handler.guid })) },
      remove: function (a) {
        c.event.remove(this,
          Y(a.origType, a.selector), a)
      } },
    beforeunload: { setup: function (a, b, d) { if (c.isWindow(this)) this.onbeforeunload = d }, teardown: function (a, b) { if (this.onbeforeunload === b) this.onbeforeunload = null } } } }; c.removeEvent = t.removeEventListener ? function (a, b, d) { a.removeEventListener && a.removeEventListener(b, d, false) } : function (a, b, d) { a.detachEvent && a.detachEvent('on' + b, d) }; c.Event = function (a) {
...
'file') return false; for (var a in V)c.event.add(this, a + '.specialChange', V[a]); return ia.test(this.nodeName)
      ...
      teardown: function () { c.event.remove(this, '.specialChange'); return ia.test(this.nodeName) } }; V = c.event.special.change.filters; V.focus = V.beforeactivate
  }t.addEventListener && c.each({ focus: 'focusin', blur: 'focusout' }, function (a, b) {
    function d (e) { e = c.event.fix(e); e.type = b; return c.event.trigger(e, null, e.target) }c.event.special[b] = { setup: function () { ua[b]++ === 0 && t.addEventListener(a, d, true) },
      teardown: function () {
        --ua[b] ===
...
1; d < b.length;)c.proxy(a, b[d++]); return this.click(c.proxy(a, function (e) { var f = (c.data(this, 'lastToggle' + a.guid) || 0) % d; c.data(this, 'lastToggle' + a.guid, f + 1); e.preventDefault(); return b[f].apply(this, arguments) || false }))
  ...
  hover: function (a, b) { return this.mouseenter(a).mouseleave(b || a) } }); var ya = { focus: 'focusin', blur: 'focusout', mouseenter: 'mouseover', mouseleave: 'mouseout' }; c.each(['live', 'die'], function (a, b) {
...
B) { n || (F = y); g = g.replace(o.match[N], ''); if (!q) return []; break }
    ...
    }; k.error = function (g) { throw 'Syntax error, unrecognized expression: ' + g }; var o = k.selectors = { order: ['ID', 'NAME', 'TAG'],
        match: { ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
          CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
          NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
          ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/,
        ...
        relative: { '+': function (g, i) {
          var n = typeof i === 'string', m = n && !/\W/.test(i); n = n && !m; if (m)i = i.toLowerCase(); m = 0; for (var p = g.length, q; m < p; m++) {
            if (q = g[m]) {
...
i ? q || false : q === i
        ...
        '>': function (g, i) { var n, m = typeof i === 'string', p = 0, q = g.length; if (m && !/\W/.test(i)) for (i = i.toLowerCase(); p < q; p++) { if (n = g[p]) { n = n.parentNode; g[p] = n.nodeName.toLowerCase() === i ? n : false } } else { for (;p < q; p++) if (n = g[p])g[p] = m ? n.parentNode : n.parentNode === i; m && k.filter(i, g, true) } },
        '': function (g, i, n) { var m, p = e++, q = b; if (typeof i === 'string' && !/\W/.test(i)) { m = i = i.toLowerCase(); q = a }q('parentNode', i, p, g, m, n) },
        '~': function (g, i, n) {
...
i = i.toLowerCase(); q = a
        ...
        CHILD: function (g) { if (g[1] === 'nth') { var i = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(g[2] === 'even' && '2n' || g[2] === 'odd' && '2n+1' || !/\D/.test(g[2]) && '0n+' + g[2] || g[2]); g[2] = i[1] + (i[2] || 1) - 0; g[3] = i[3] - 0 }g[0] = e++; return g },
        ATTR: function (g, i, n,
          m, p, q) { i = g[1].replace(/\\/g, ''); if (!q && o.attrMap[i])g[1] = o.attrMap[i]; if (g[2] === '~=')g[4] = ' ' + g[4] + ' '; return g },
        PSEUDO: function (g, i, n, m, p) { if (g[1] === 'not') if ((d.exec(g[3]) || '').length > 1 || /^\w/.test(g[3]))g[3] = k(g[3], null, null, i); else { g = k.filter(g[3], i, n, true ^ p); n || m.push.apply(m, g); return false } else if (o.match.POS.test(g[0]) || o.match.CHILD.test(g[0])) return true; return g },
...
true
          ...
          text: function (g) { return g.type === 'text' },
          radio: function (g) { return g.type === 'radio' },
          checkbox: function (g) { return g.type === 'checkbox' },
          file: function (g) { return g.type === 'file' },
          password: function (g) { return g.type === 'password' },
          submit: function (g) {
            return g.type ===
'submit'
          },
          image: function (g) { return g.type === 'image' },
          reset: function (g) { return g.type === 'reset' },
          button: function (g) { return g.type === 'button' || g.nodeName.toLowerCase() === 'button' },
...
0 === i
        ...
        filter: { PSEUDO: function (g, i, n, m) { var p = i[1], q = o.filters[p]; if (q) return q(g, n, i, m); else if (p === 'contains') return (g.textContent || g.innerText || k.getText([g]) || '').indexOf(i[3]) >= 0; else if (p === 'not') { i = i[3]; n = 0; for (m = i.length; n < m; n++) if (i[n] === g) return false; return true } else k.error('Syntax error, unrecognized expression: ' + p) },
          CHILD: function (g, i) {
...
i
      ...
      C = function (g, i) {
        var n = 0, m = i || []; if (f.call(g) === '[object Array]') {
          Array.prototype.push.apply(m,
            g)
        } else if (typeof g.length === 'number') for (var p = g.length; n < p; n++)m.push(g[n]); else for (;g[n]; n++)m.push(g[n]); return m
      }
...
t.createElement('div'); g.innerHTML = "<div class='test e'></div><div class='test'></div>"; if (!(!g.getElementsByClassName || g.getElementsByClassName('e').length === 0)) { g.lastChild.className = 'e'; if (g.getElementsByClassName('e').length !== 1) { o.order.splice(1, 0, 'CLASS'); o.find.CLASS = function (i, n, m) { if (typeof n.getElementsByClassName !== 'undefined' && !m) return n.getElementsByClassName(i[1]) }; g = null } }
  ...
  })(); var Za = /Until$/, $a = /^(?:parents|prevUntil|prevAll)/, ab = /,/, Na = /^.[^:#\[\.,]*$/, bb = Array.prototype.slice, cb = c.expr.match.POS; c.fn.extend({ find: function (a) { for (var b = this.pushStack('', 'find', a), d = 0, e = 0, f = this.length; e < f; e++) { d = b.length; c.find(a, this[e], b); if (e > 0) for (var h = d; h < b.length; h++) for (var l = 0; l < d; l++) if (b[l] === b[h]) { b.splice(h--, 1); break } } return b },
...
h.parentNode; o++
    ...
    contents: function (a) { return c.nodeName(a, 'iframe') ? a.contentDocument || a.contentWindow.document : c.makeArray(a.childNodes) } }, function (a,
    b) { c.fn[a] = function (d, e) { var f = c.map(this, b, d); Za.test(a) || (e = d); if (e && typeof e === 'string')f = c.filter(e, f); f = this.length > 1 ? c.unique(f) : f; if ((this.length > 1 || ab.test(e)) && $a.test(a))f = f.reverse(); return this.pushStack(f, a, bb.call(arguments).join(',')) } }); c.extend({ filter: function (a, b, d) { if (d)a = ':not(' + a + ')'; return b.length === 1 ? c.find.matchesSelector(b[0], a) ? [b[0]] : [] : c.find.matches(a, b) },
    dir: function (a, b, d) {
...
e.push(a); a = a[b]
    ...
    nth: function (a, b, d) { b = b || 1; for (var e = 0; a; a = a[d]) if (a.nodeType === 1 && ++e === b) break; return a },
    sibling: function (a, b) { for (var d = []; a; a = a.nextSibling)a.nodeType === 1 && a !== b && d.push(a); return d } }); var za = / jQuery\d+="(?:\d+|null)"/g, $ = /^\s+/, Aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, Ba = /<([\w:]+)/, db = /<tbody/i, eb = /<|&#?\w+;/, Ca = /<(?:script|object|embed|option|style)/i, Da = /checked\s*(?:[^=]|=\s*.checked.)/i, fb = /\=([^="'>\s]+\/)>/g, P = { option: [1,
  ...
  area: [1, '<map>', '</map>'],
  _default: [0, '', ''] }; P.optgroup = P.option; P.tbody = P.tfoot = P.colgroup = P.caption = P.thead; P.th = P.td; if (!c.support.htmlSerialize)P._default = [1, 'div<div>', '</div>']; c.fn.extend({ text: function (a) {
    if (c.isFunction(a)) {
...
c(this); d.text(a.call(this, b, d.text()))
  ...
  wrapInner: function (a) { if (c.isFunction(a)) return this.each(function (b) { c(this).wrapInner(a.call(this, b)) }); return this.each(function () { var b = c(this), d = b.contents(); d.length ? d.wrapAll(a) : b.append(a) }) },
  ...
  before: function () { if (this[0] && this[0].parentNode) return this.domManip(arguments, false, function (b) { this.parentNode.insertBefore(b, this) }); else if (arguments.length) { var a = c(arguments[0]); a.push.apply(a, this.toArray()); return this.pushStack(a, 'before', arguments) } },
  after: function () {
  ...
  remove: function (a, b) { for (var d = 0, e; (e = this[d]) != null; d++) if (!a || c.filter(a, [e]).length) { if (!b && e.nodeType === 1) { c.cleanData(e.getElementsByTagName('*')); c.cleanData([e]) }e.parentNode && e.parentNode.removeChild(e) } return this },
  empty: function () {
    for (var a = 0, b; (b = this[a]) != null; a++) for (b.nodeType === 1 && c.cleanData(b.getElementsByTagName('*')); b.firstChild;)b.removeChild(b.firstChild)
    return this
  },
  clone: function (a) { var b = this.map(function () { if (!c.support.noCloneEvent && !c.isXMLDoc(this)) { var d = this.outerHTML, e = this.ownerDocument; if (!d) { d = e.createElement('div'); d.appendChild(this.cloneNode(true)); d = d.innerHTML } return c.clean([d.replace(za, '').replace(fb, '="$1">').replace($, '')], e)[0] } else return this.cloneNode(true) }); if (a === true) { na(this, b); na(this.find('*'), b.find('*')) } return b },
  html: function (a) {
...
c(this), e = d.html(); d.replaceWith(a.call(this, b, e))
  ...
  domManip: function (a, b, d) {
    var e, f, h, l = a[0], k = []; if (!c.support.checkClone && arguments.length === 3 && typeof l === 'string' && Da.test(l)) {
      return this.each(function () {
        c(this).domManip(a,
          b, d, true)
      })
      ...
      e = l && l.parentNode; e = c.support.parentNode && e && e.nodeType === 11 && e.childNodes.length === this.length ? { fragment: e } : c.buildFragment(a, this, k); h = e.fragment; if (f = h.childNodes.length === 1 ? h = h.firstChild : h.firstChild) {
        b = b && c.nodeName(f, 'tr'); f = 0; for (var o = this.length; f < o; f++) {
...
1; o >= 0; --o)c.nodeName(k[o], 'tbody') && !k[o].childNodes.length && k[o].parentNode.removeChild(k[o])
  ...
  cleanData: function (a) { for (var b, d, e = c.cache, f = c.event.special, h = c.support.deleteExpando, l = 0, k; (k = a[l]) != null; l++) if (!(k.nodeName && c.noData[k.nodeName.toLowerCase()])) if (d = k[c.expando]) { if ((b = e[d]) && b.events) for (var o in b.events)f[o] ? c.event.remove(k, o) : c.removeEvent(k, o, b.handle); if (h) delete k[c.expando]; else k.removeAttribute && k.removeAttribute(c.expando); delete e[d] } } }); var Ea = /alpha\([^)]*\)/i, gb = /opacity=([^)]*)/, hb = /-([a-z])/ig, ib = /([A-Z])/g, Fa = /^-?\d+(?:px)?$/i,
    jb = /^-?\d/, kb = { position: 'absolute', visibility: 'hidden', display: 'block' }, Pa = ['Left', 'Right'], Qa = ['Top', 'Bottom'], W, Ga, aa, lb = function (a, b) { return b.toUpperCase() }; c.fn.css = function (a, b) { if (arguments.length === 2 && b === B) return this; return c.access(this, a, b, true, function (d, e, f) { return f !== B ? c.style(d, e, f) : c.css(d, e) }) }; c.extend({ cssHooks: { opacity: { get: function (a, b) { if (b) { var d = W(a, 'opacity', 'opacity'); return d === '' ? '1' : d } else return a.style.opacity } } },
    ...
    swap: function (a, b, d) { var e = {}, f; for (f in b) { e[f] = a.style[f]; a.style[f] = b[f] }d.call(a); for (f in b)a.style[f] = e[f] },
    camelCase: function (a) { return a.replace(hb, lb) } }); c.curCSS = c.css; c.each(['height', 'width'], function (a, b) {
    ...
    c.cssHooks.opacity = { get: function (a, b) { return gb.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || '') ? parseFloat(RegExp.$1) / 100 + '' : b ? '1' : '' },
      set: function (a, b) {
...
d.filter || ''; d.filter = Ea.test(f) ? f.replace(Ea, e) : d.filter + ' ' + e
    ...
    if (typeof a !== 'string' && Ha) return Ha.apply(this, arguments); else if (!this.length) return this; var e = a.indexOf(' '); if (e >= 0) { var f = a.slice(e, a.length); a = a.slice(0, e) }e = 'GET'; if (b) {
      if (c.isFunction(b)) { d = b; b = null } else if (typeof b ===
'object') { b = c.param(b, c.ajaxSettings.traditional); e = 'POST' }
    } var h = this; c.ajax({ url: a, type: e, dataType: 'html', data: b, complete: function (l, k) { if (k === 'success' || k === 'notmodified')h.html(f ? c('<div>').append(l.responseText.replace(nb, '')).find(f) : l.responseText); d && h.each(d, [l.responseText, k, l]) } }); return this
  },
...
!T.test(b.data))b.data = (b.data ? b.data + '&' : '') + (b.jsonp || 'callback') + '=?'; b.dataType = 'json'
        ...
        b.cache =
false
      } if (b.cache === false && l) { var o = c.now(), x = b.url.replace(rb, '$1_=' + o); b.url = x + (x === b.url ? (ja.test(b.url) ? '&' : '?') + '_=' + o : '') } if (b.data && l)b.url += (ja.test(b.url) ? '&' : '?') + b.data; b.global && c.active++ === 0 && c.event.trigger('ajaxStart'); o = (o = sb.exec(b.url)) && (o[1] && o[1].toLowerCase() !== location.protocol || o[2].toLowerCase() !== location.host); if (b.dataType === 'script' && h === 'GET' && o) {
...
c.triggerGlobal(b, 'ajaxSend', [w, b]); var L = w.onreadystatechange = function (m) {
          if (!w || w.readyState === 0 || m === 'abort') { J || c.handleComplete(b, w, e, f); J = true; if (w)w.onreadystatechange = c.noop } else if (!J && w && (w.readyState === 4 || m === 'timeout')) {
            J = true; w.onreadystatechange = c.noop; e = m === 'timeout' ? 'timeout' : !c.httpSuccess(w) ? 'error' : b.ifModified && c.httpNotModified(w, b.url) ? 'notmodified' : 'success'; var p; if (e === 'success') try { f = c.httpData(w, b.dataType, b) } catch (q) { e = 'parsererror'; p = q } if (e === 'success' || e === 'notmodified') {
              d ||
...
encodeURIComponent(h) + '=' + encodeURIComponent(l)
  ...
  if (E.ActiveXObject)c.ajaxSettings.xhr = function () { if (E.location.protocol !== 'file:') try { return new E.XMLHttpRequest() } catch (a) {} try { return new E.ActiveXObject('Microsoft.XMLHTTP') } catch (b) {} }; c.support.ajax = !!c.ajaxSettings.xhr(); var ea = {}, vb = /^(?:toggle|show|hide)$/, wb = /^([+\-]=)?([\d+.\-]+)(.*)$/, ba, pa = [['height', 'marginTop', 'marginBottom', 'paddingTop', 'paddingBottom'], ['width', 'marginLeft', 'marginRight', 'paddingLeft', 'paddingRight'], ['opacity']]; c.fn.extend({ show: function (a, b, d) {
    if (a || a === 0) {
      return this.animate(S('show',
        3), a, b, d)
    } else { d = 0; for (var e = this.length; d < e; d++) { a = this[d]; b = a.style.display; if (!c.data(a, 'olddisplay') && b === 'none')b = a.style.display = ''; b === '' && c.css(a, 'display') === 'none' && c.data(a, 'olddisplay', qa(a.nodeName)) } for (d = 0; d < e; d++) { a = this[d]; b = a.style.display; if (b === '' || b === 'none')a.style.display = c.data(a, 'olddisplay') || '' } return this }
  },
  hide: function (a, b, d) {
  ...
  _toggle: c.fn.toggle,
  toggle: function (a, b, d) { var e = typeof a === 'boolean'; if (c.isFunction(a) && c.isFunction(b)) this._toggle.apply(this, arguments); else a == null || e ? this.each(function () { var f = e ? a : c(this).is(':hidden'); c(this)[f ? 'show' : 'hide']() }) : this.animate(S('toggle', 3), a, b, d); return this },
...
1) / J.cur() * I; c.style(x, A, I + g)
  ...
  stop: function (a, b) { var d = c.timers; a && this.queue([]); this.each(function () { for (var e = d.length - 1; e >= 0; e--) if (d[e].elem === this) { b && d[e](true); d.splice(e, 1) } }); b || this.dequeue(); return this } }); c.each({ slideDown: S('show', 1), slideUp: S('hide', 1), slideToggle: S('toggle', 1), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, function (a, b) {
...
Math.PI) / 2 + 0.5) * e + d
    ...
    timers: [],
    fx: function (a, b, d) { this.options = b; this.elem = a; this.prop = d; if (!b.orig)b.orig = {} } }); c.fx.prototype = { update: function () { this.options.step && this.options.step.call(this.elem, this.now, this); (c.fx.step[this.prop] || c.fx.step._default)(this) },
...
c.timers, b = 0; b < a.length; b++)a[b]() || a.splice(b--, 1); a.length || c.fx.stop()
  ...
  interval: 13,
  stop: function () { clearInterval(ba); ba = null },
  speeds: { slow: 600, fast: 200, _default: 400 },
  step: { opacity: function (a) { c.style(a.elem, 'opacity', a.now) }, _default: function (a) { if (a.elem.style && a.elem.style[a.prop] != null)a.elem.style[a.prop] = (a.prop === 'width' || a.prop === 'height' ? Math.max(0, a.now) : a.now) + a.unit; else a.elem[a.prop] = a.now } } }); if (c.expr && c.expr.filters) {
...
parseFloat(d.borderTopWidth) || 0; o += parseFloat(d.borderLeftWidth) || 0
    ...
    var a = t.body, b = t.createElement('div'), d, e, f, h = parseFloat(c.css(a, 'marginTop')) || 0; c.extend(b.style, { position: 'absolute',
      top: 0,
      left: 0,
      margin: 0,
      border: 0,
...
c.css(a, 'position') === 'static';)a = a.offsetParent; return a
    ...
    c.fn['inner' + b] = function () { return this[0] ? parseFloat(c.css(this[0], d, 'padding')) : null }; c.fn['outer' + b] = function (e) { return this[0] ? parseFloat(c.css(this[0], d, e ? 'margin' : 'border')) : null }; c.fn[d] = function (e) {
      var f = this[0]; if (!f) return e == null ? null : this; if (c.isFunction(e)) return this.each(function (l) { var k = c(this); k[d](e.call(this, l, k[d]())) }); if (c.isWindow(f)) return f.document.compatMode === 'CSS1Compat' && f.document.documentElement['client' + b] || f.document.body['client' + b]; else if (f.nodeType === 9) {
